...
const navItems = [
  ...
  { href: "/superadmin/articles", label: "Review Artikel", icon: FileText },
  {
    ...
    label: "Review Kegiatan",
    icon: CalendarDays,
  },
  { href: "/superadmin/admins", label: "Kelola Admin", icon: Users },
  { href: "/superadmin/sccp", label: "SCCP Registrations", icon: Users },
];
...
export default function SuperAdminLayout({
  ...
  useEffect(() => {
    ...
    const id = window.setTimeout(() => setIsLoggedIn(true), 0);
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-gray-950 text-white flex flex-col transform transition-transform duration-300 ease-in-out ${
