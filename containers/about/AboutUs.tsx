  ...
  return (
    <section className="relative h-screen min-h-[600px] overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-20 px-6">
        ...
        >
          Student chapter <strong className="text-white">pertama</strong> yang
          dibentuk langsung oleh INDOCOR Pusat — jembatan antara dunia akademik
          dan industri korosi Indonesia.
        </motion.p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mt-4">
          ...
          <FadeIn direction="right" delay={0.05}>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <strong>19 Januari 1973</strong> sebagai wadah bagi para
              profesional untuk mengatasi masalah korosi di sektor industri
              Indonesia.
            </p>
            <p className="text-gray-600 leading-relaxed">
              Menjadi media informasi, komunikasi, dan berbagi pengalaman
              terkait pengendalian korosi di berbagai infrastruktur — dengan
              tujuan menekan kerugian ekonomi akibat korosi yang diperkirakan
              mencapai <strong>2–5% dari GNP</strong> negara.
            </p>
          </FadeIn>
            ...
            <FadeIn direction="left" delay={0.1}>
              <div className="grid grid-cols-2 gap-4">
                {indocorFacts.map((f) => (
                  <div
                    key={f.label}
                    className="border border-gray-200 p-5 rounded-sm bg-white hover:border-red/40 transition-colors"
                  >
        ...
        <FadeIn direction="up">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-14">
            ...
            <p className="text-gray-500 text-sm max-w-sm leading-relaxed md:text-right">
              ...
              program yang mempersiapkan mahasiswa untuk industri.
            </p>
          </div>
        </FadeIn>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <FadeIn direction="right">
            ...
            <h2 className="text-[clamp(2rem,4.5vw,3.2rem)] font-extrabold leading-tight tracking-tight text-black mb-6">
              Apa itu <span className="text-red">INDOCOR ITS SC?</span>
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              <strong>INDOCOR ITS SC (Student Chapter)</strong> adalah
              organisasi mahasiswa di bawah naungan{" "}
              <strong>Asosiasi Korosi Indonesia (INDOCOR)</strong>.
            </p>
            <p className="text-gray-600 leading-relaxed">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mt-6 border-l-2 border-red pl-4 italic">
              ...
              dengan kebutuhan industri, khususnya dalam pengelolaan korosi yang
              berdampak besar pada pembangunan.
            </p>
          </FadeIn>
