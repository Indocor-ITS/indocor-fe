  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const GOOGLE_SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbx5D-SfoQeEulglojrgXB69Kykzkgi5vh1td1RuNRD__JCoBI8GY4UmHTvPTDbfhJzq/exec";
        ...
        <FadeIn direction="up">
          <div className="bg-white p-10 md:p-14 rounded-xl shadow-sm border border-gray-100 text-center max-w-lg w-full">
            ...
            <p className="text-gray-600 leading-relaxed mb-8">
              ...
              dan bukti pembayaran Anda telah kami terima dan masuk ke dalam
              database kami. Tim kami akan segera menghubungi Anda melalui
              WhatsApp.
            </p>
            <button
        ...
        <FadeIn direction="up">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto leading-relaxed">
              Pilih paket sertifikasi yang sesuai dengan kebutuhan Anda dan
            ...
            <div className="p-8 md:p-12 border-b border-gray-100 bg-gray-50/50">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {packages.map((pkg) => (
                  <label
                    key={pkg.id}
                    className={`relative flex flex-col p-6 rounded-xl border-2 cursor-pointer transition-all hover:shadow-md ${
                      pkg.highlight
                  ...
                  >
                    ...
                    <div className="mb-4 pr-8">
                      ...
                      <p className="text-xl font-extrabold text-red mt-1">
                        {pkg.price}
                      </p>
                    </div>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-5 mb-6">
                <p className="text-sm text-yellow-800 leading-relaxed">
                  Silakan transfer sesuai dengan nominal paket yang dipilih ke
                  rekening berikut:
                  <br />
                  <strong>BCA: 1234567890 a.n INDOCOR ITS SC</strong>
                  <br />
                    ...
                    {fileName ? (
                      ...
                      <>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Klik atau drag & drop file di sini (Max 3MB, .jpg,
                          .png)
                        </p>
                      </>
                    )}
