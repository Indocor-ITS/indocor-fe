        ...
        {events.map((event, index) => {
          ...
          return (
            ...
            >
              {/* Header */}
              <div
                className={`w-full py-8 md:py-10 px-6 md:px-12 lg:px-20 flex items-center justify-between cursor-pointer transition-colors ${isActive ? "bg-[#EF3D3D]" : "bg-[#EF3D3D] hover:bg-[#D32F2F]"}`}
              >
